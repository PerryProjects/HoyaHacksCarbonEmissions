...
function App() {
  return (
    <div className="App">
       <Parallax pages={4} scrolling={true} vertical ref={ref => (React.parallax = ref)}>
        <ParallaxLayer offset={0} speed={0.5} factor={1.5} style={{ backgroundColor: '#253237', backgroundSize: 'cover' }}>
        ...
        {/* <ParallaxLayer offset={1.3} speed={0.8} style={{ opacity: 0.1 }}>
          ...
          <img src={url('cloud')} style={{ display: 'block', width: '8%', marginLeft: '15%', marginTop: '3%' }} />
        </ParallaxLayer> */}

        <ParallaxLayer offset={0.5} speed={0.8} style={{ opacity: 1 }}>
          <img src={plane} style={{ display: 'block', width: '10%', marginLeft: '60%', marginTop: '10%' }} />
        </ParallaxLayer>
        ...
        <ParallaxLayer offset={2.3} speed={0.1} factor={1} style={{ backgroundColor: '#9b7653' }} />
