    ...
    return (
      <div className="App">
        ...
        {/* <Parallax pages={3} scrolling={true} vertical ref={ref => (React.parallax = ref)}>
          ...
          <ParallaxLayer offset={2.8} speed={0.8} style={{ opacity: 0.9 }}>
            <img src={humanSkull} style={{ display: 'block', width: '5%', marginLeft: '25%' }} />
            <img src={humanSkull} style={{ display: 'block', width: '5%', marginLeft: '75%', transform: 'scaleX(-1)' }} />
